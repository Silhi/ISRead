                  ...
                  children: [
                    ...
                    CircleAvatar(
                      backgroundImage: currentUser!.profpic.isNotEmpty
                          ...
                          : AssetImage("assets/avatar/dummy.jpg")
                              as ImageProvider,
                      radius: 50,
                    ),
                    SizedBox(height: 16),
                      ...
                      if (isLoading)
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            var terlambat = sekarang.isAfter(batasPengembalian)
                                ? sekarang.difference(batasPengembalian).inDays
                                : 0;
                            var statusSelesai =
    ...
    builder: (context) {
      return AlertDialog(
        title: Text(
          'Edit Profile',
          style: TextStyle(
            fontWeight: FontWeight.bold, // Untuk teks tebal
                  ...
                  decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                      borderSide: BorderSide(
                          color: Colors.white), // Warna garis saat tidak fokus
                    ),
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                try {
                  ...
                  onUpdate(); // Memanggil fungsi callback untuk memperbarui UI
