...
class TColor {
  static Color get primary => const Color(0xff112D4E);
  static Color get primaryLight => const Color(0xff3F72AF);
  static Color get latar => const Color(0xffF9F7F7);
  static Color get latar2 => const Color(0xffDBE2EF);
